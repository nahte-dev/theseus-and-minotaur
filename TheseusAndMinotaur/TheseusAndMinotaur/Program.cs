...
namespace TheseusAndMinotaur
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"CurrentLevel: {game.CurrentLevelName}." +
                $"{ game.LevelWidth} x { game.LevelHeight}\n");
            ...
            game.AddLevel("ThesesusIn3by3", 3, 3, "0000 0101 0202"
                + " 1111 1001 1100"
                + " 1001 0000 0100"
                + " 0011 0010 0110");
            Console.WriteLine($"CurrentLevel: {game.CurrentLevelName}." +
            ...
            game.AddLevel("BlockedThesesusIn3by3", 3, 3, "0000 0101 0202"
                + " 1111 1001 1100"
                + " 1101 1111 0101"
                + " 0011 1010 0110");
            Console.WriteLine($"CurrentLevel: {game.CurrentLevelName}." +
            ...
            game.AddLevel("CentredMinotaurThesesusIn7by7", 7, 7, "0303 0003 0001"
